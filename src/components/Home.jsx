      ...
      >
        <main>
          ...
          <div className=" max-w-7xl py-6 px-10 sm:px-10 lg:px-8  absolute top-16">
            ...
            <h1 className="text-3xl font-medium tracking-tight text-purple-400 dark:text-purple-800">
              Showcasing creativity through code.
            </h1>
            <div className="py-6">
              <button className=" max-w-screen-sm px-8  py-2 rounded-md bg-red-500 border-solid border-1 border-red-500 hover:bg-red-600 text-white dark:text-black sm:px-4 lg:px-5 ">
                Learn more
              </button>
            </div>
          </div>
